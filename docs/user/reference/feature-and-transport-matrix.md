...
| 4-byte Write Single Register values | Yes | No | No | Built-in RTU framing assumes 2-byte values; see [Write Single Register values](function-codes-and-pdus.md#write-single-register-values) |
